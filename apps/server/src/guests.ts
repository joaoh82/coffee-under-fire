    ...
    if (path === "/access/guest") {
      ...
      try {
        ...
        if (!identity) {
          ...
          const token = this.store.createGuest(network);
          res.setHeader(
            "Set-Cookie",
