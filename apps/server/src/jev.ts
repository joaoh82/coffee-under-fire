        ...
        instructions:
          r.observation.role === "general"
            ...
            : r.observation.role === "tank"
              ...
              : r.observation.archetype &&
                  r.observation.archetype !== "rifleman"
                ? `You control a ${r.observation.archetype} in an arena shooter. ${r.observation.archetype === "scout" ? "You move quickly but fire only within 7 meters. Use your mobility to close in or reposition, then attack." : r.observation.archetype === "gunner" ? "You move slowly and fire rapid bursts within 12 meters. Choose firing opportunities and reposition between bursts." : "You fire single deliberate shots within 18 meters after a visible 0.6-second warning. Use open sightlines and reposition when enemies close in."} Your movement speed, firing range and timing are in observation.combat. Choose ONE complete legal candidate. Only you choose tactics: the executor does not pursue, fire, reload or reposition without your selection. Use only visible contacts or the supplied temporary memories and approximate sounds. Search when no contact is known. Hold is a brief tactical pause.`
