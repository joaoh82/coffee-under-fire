...
4. Create/edit an invite by name; new blank passwords are generated and displayed once. Existing blank passwords are unchanged. Disabling access, resetting a password, or reducing concurrency ends affected games. Default concurrency is one, maximum eight.
